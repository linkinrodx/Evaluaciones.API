...
namespace Proyecto.Evaluacion.API.Infraestructure.ExceptionHandler
{
    public class GlobalExceptionMiddleware
    {
        ...
        private static Task HandleExceptionAsync(HttpContext httpContext, Exception exception) {
            ...
            var messageException = (exception == null || string.IsNullOrEmpty(exception.Message)) ? "Contacte con el administrador del sistema" : exception.Message;
